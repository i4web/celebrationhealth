   ...
   <div class="footer-menu-wrapper">
     <div class="row">
       <div class="columns large-3">
         <h5>Resources</h5>
         <a href="#">Forms</a> <br> <a href="#">Maps</a>
       </div>
       <div class="columns large-6">
         <h5>Creation Health</h5>
         <div class="creation-health-logo">
           <div class="creation-health-acronym-wrapper large-8 columns">
       ...
       <div class="columns large-3">
         <h5>Contact Us</h5>
         <a href="#">Questions</a> <br> <a href="#">Technical Support</a>
       </div>
     </div>
   </div>
