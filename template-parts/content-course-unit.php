...
$i4_coordinator_name = $i4_course_coordinator->coordinator_name;
$i4_coordinator_email = $i4_course_coordinator->coordinator_email;
        ...
        <div class="course-coordinator-wrapper large-12 columns">
          <div class="course-coordinator-details">
              <div class="course-coordinator-img">
                <img src="<?php echo $i4_course_coordinator->coordinator_img; ?>" alt="Coordinator Name" class="img-circle">
              </div>
                ...
                <div id="askCoordinatorModal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
                    <p class="text-center"><img src="<?php echo $i4_course_coordinator->coordinator_img; ?>" alt="<?php echo $i4_coordinator_name;?>" class="img-circle"></p>
